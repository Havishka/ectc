...
$ret=mysqli_query($con,"select count(id) as id4 from lecture_reg ");
 ...
 $ret=mysqli_query($con,"select count(id) as id6 from lec_pay where finalize='Approved' and (pay_month = MONTH(CURRENT_DATE()) and pay_year = YEAR(CURRENT_DATE()))");
 $row3=mysqli_fetch_array($ret);  

 $ret=mysqli_query($con,"select count(id) as id7 from lec_pay where finalize!='Approved'");
...
// where expdate>CURDATE()
    ...
    <table class="table table-striped table-bordered"   width="96%"   cellspacing="0">
            ...
            <?php
              $ret=mysqli_query($con,"select * from lec_pay where finalize='Approved' and (pay_month = MONTH(CURRENT_DATE()) and pay_year = YEAR(CURRENT_DATE()))");
    ...
    <div class="container" style="display: none; width: 80%; padding-left:10%; " id="moreinfo4">
    <h4>Approval Pending Lectures</h4><br>
            ...
            <?php
              $ret=mysqli_query($con,"select * from lec_pay where finalize!='Approved'");
