              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="row" style="margin-bottom:20px;">
					...
					<label for="email">Lecturer Name</label></div><br>
			
					<!--<input type="text" class="form-control" name="nic" placeholder="Type NIC" required>-->

<input type="text" id="search-box" name="search-box" required placeholder="Search By Name..." size="60" name="f_name" autocomplete="off" /> 
