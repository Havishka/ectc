            ...
            ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php if (($mydate >= date("Y-m", strtotime("-2 months")) && ($mydate <= date("Y-m")))) { ?>
                                <td>
                                    <a href="Lecture/decline.php?id=<?php echo $row['id']; ?>" class="btn btn-xs btn-danger">Remove<i class="feather icon-clock m-t-10 f-16 "></i></a>
                                </td>
