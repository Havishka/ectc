...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($check) > 0) {
    ...
    if ($query) {
      ...
      echo "<script>alert('Successfully registered!'); window.location.href=''; </script>";
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <button <?php $id=$row['id']?> class="delete btn-xs btn-danger" type="button" id='del_<?= $id ?>' data-id='<?= $id ?>' name="delete_btn"> Remove<i class="feather icon-clock m-t-10 f-16 "></i></button>
                </td>
