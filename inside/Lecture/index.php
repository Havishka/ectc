...
$ret=mysqli_query($con,"select count(id) as id4 from lecture_reg ");
 ...
 $ret=mysqli_query($con,"select count(id) as id6 from t_time where approval='Approved' and MONTH(rdate)=MONTH(CURRENT_DATE())");
 $row3=mysqli_fetch_array($ret);  

 $ret=mysqli_query($con,"select count(id) as id7 from t_time where approval='Not Approved'");
...
<br><br>
    <div class="container" style=" display:none; width: 80%; padding-left:15% " id="moreinfo1">
    ...
    <div class="container" style=" display:none; width: 80%; padding-left:15%;" id="moreinfo2">
    ...
    <h4>Course Details</h4><br>
            ...
            <?php
            $d=date('M Y');
              $ret=mysqli_query($con,"select * from course where state='T'");
...
// where expdate>CURDATE()
    ...
    <div class="container" style=" display: none; width: 80%; padding-left:15%" id="moreinfo3">
    ...
    <table class="table table-striped table-bordered"   width="96%"   cellspacing="0">
            ...
            <?php
              $ret=mysqli_query($con,"select * from t_time where approval='Approved' and MONTH(rdate)=MONTH(CURRENT_DATE())");
    ...
    <div class="container" style="display: none; width: 80%; padding-left:15%" id="moreinfo4">
    <h4>Approval Pending Lectures</h4><br>
            ...
            <?php
              $ret=mysqli_query($con,"select * from t_time where approval='Not Approved'");
