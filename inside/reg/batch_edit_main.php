        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <div class='input-group date' id='myDatepicker'>
              <input type='date' class="field" name="startdate" placeholder="Start Date" value='<?php echo $batch_start_date; ?>' />
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <div class='input-group date' id='myDatepicker2'>
              <input type='date' class="field" name="enddate" placeholder="End Date" value='<?php echo $batch_end_date; ?>' />
  ...
  <input type='text' name='regFee' class="field" value='<?php echo $regFee; ?>' />
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            ...
            <button type="button" class="btn btn-danger" onClick="location.href='index.php?tab=batch_reg'">Cancel</button>
          </div>
        </div>
      </form>
